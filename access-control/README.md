...
1. [وظائف إدارية غير محمية](labs/01-admin-unprotected.md)
2. [وظائف إدارية بروابط غير متوقعة](labs/02-admin-unpredictable-url.md)
3. [التحكم في الأدوار عبر معاملات الطلب](labs/03-role-request-param.md)
4. [تعديل الأدوار في ملف الشخصي](labs/04-role-user-profile.md)
5. [التحكم في معرّف المستخدم (User ID)](labs/05-uid-request-param.md)
6. [تجاوز التحكم في الوصول القائم على الروابط](labs/06-url-bypass.md)
7. [التحكم في معرّف المستخدم مع مفتاح API](labs/07-uid-param-api-key.md)
8. [تجاوز التحكم القائم على طرق HTTP](labs/08-method-bypass.md)
9. [التحكم في معرّف المستخدم مع معرّفات غير متوقعة](labs/09-uid-param-unpredictable.md)
10. [تسريب البيانات في التحويل (Redirect)](labs/10-uid-param-leak-redirect.md)
11. [كشف كلمة المرور عبر معرّف المستخدم](labs/11-uid-param-pass-disclosure.md)
12. [ثغرة IDOR الأساسية](labs/12-idor-basic.md)
13. [عملية متعددة الخطوات بدون حماية](labs/13-multi-step-no-ac.md)
14. [التحكم في الوصول القائم على الـ Referer](labs/14-referer-ac.md)
