...
## 🎯 المختبر التفاعلي (Interactive Vulnerability Lab) [NEW]

يتضمن المستودع تطبيق ويب كامل مكتوب بـ **Python Flask** للتدريب العملي بنظام الـ Black Box:

*   **المكان:** [vulnerable-app/](vulnerable-app/)
*   **المستويات:** 10 مستويات متدرجة الصعوبة (تنتقل من شركة ناشئة إلى أنظمة سحابية معقدة).
*   **الوصف:** التطبيق مصمم ليحاكي المواقع الحقيقية وليس مجرد لابات منفصلة، مما يساعدك على التعود على بيئات العمل الحقيقية.
*   **التشغيل:** اتبع التعليمات في [vulnerable-app/HELP.md](vulnerable-app/HELP.md).
